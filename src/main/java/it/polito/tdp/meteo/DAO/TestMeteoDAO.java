...
public class TestMeteoDAO {
	...
	public static void main(String[] args) {
		...
		System.out.println(dao.AVGUmiditaLocalitaMese(1, "Genova"));
		
		System.out.println(dao.getAllRilevamentiLocalitaMese(5, "Milano"));
		System.out.println(dao.AVGUmiditaLocalitaMese(5, "Milano"));
		
		System.out.println(dao.getAllRilevamentiLocalitaMese(5, "Torino"));
		System.out.println(dao.AVGUmiditaLocalitaMese(5, "Torino"));
